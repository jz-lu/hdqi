...
TYPE 4: k-sparse Pauli (X, Y, Z equally likely)
"""
import numpy as np
import argparse
...
def sample_commuting_Paulis(m, n, k):
    ...
    At each step, choose a random k-sparse XZ-symplectic vector.
    ...
    while counter < m:
        ...
        while not found:
            ...
            Pauli_new = rand_k_sparse_Pauli(n, k)
